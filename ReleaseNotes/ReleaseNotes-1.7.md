...
[![Hundreds of lights](/ReleaseNotes/media//ReleaseNotes-1.7/launcher_lights.jpg)](https://www.youtube.com/watch?v=QWZqNT9xD5Q "Hundreds of lights")
...
![Vulkan](/ReleaseNotes/media//ReleaseNotes-1.7/Vulkan.png)
...
![New add asset menu](/ReleaseNotes/media//ReleaseNotes-1.7/NewAddAsset.png)
...
![Camera preview](/ReleaseNotes/media//ReleaseNotes-1.7/CameraPreview.png)
...
![Drag & Drop into the Property Grid](/ReleaseNotes/media//ReleaseNotes-1.7/dragdrop_propertyview.gif)

### Drag & Drop scripts

You can also drag & drop scripts directly into the scene, tree view and property view:

![Drag & Drop into the Property Grid](/ReleaseNotes/media//ReleaseNotes-1.7/dragdrop_scripts.gif)
...
![Select Platforms Dialog](/ReleaseNotes/media//ReleaseNotes-1.7/linux2.png)

Deployment to a remote Linux box is done via SSH when running your project from GameStudio.

![Platform Selector](/ReleaseNotes/media//ReleaseNotes-1.7/Platform_selector.png)
...
- Implemented the required changes to allow rendering to Oculus Rift devices. Also, we have already begun including the native interfaces in the API for the Oculus Rift SDK. Check this [link](../manual/graphics/oculus/index.html) for more info.
